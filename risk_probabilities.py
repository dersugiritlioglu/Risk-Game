            ...
            for d1 in dice:
                for d2 in dice:
                    for d3 in dice:
                        ...
                        a_others.remove(a_max2)
                        d_others.remove(d_max2)
                        
                        if a_others[0] >= d_others[0]:
                            a_death += 1
                        else:
                            d_death += 1
...
print("3A - 3D: ", "{:12.2f}".format(a_2dead/6**6*100), "{:21.2f}".format(draw/6**6*100), "{:17.2f}".format(d_2dead/6**6*100))
